...
const groups2021 = {
	...
	Sleeping: { x: (713 / width) * width, y: height / 2, color: "#0A9396", cnt: 0, fullname: "Sleeping" },
	"Personal Care": {
		x: (697 / width) * width,
		y: (490 / height) * height,
		color: "#4FB3AA",
	...
	Work: { x: (496 / width) * width, y: (659 / height) * height, color: "#E9D8A6", cnt: 0, fullname: "Work" },
	Housework: {
		x: (404 / width) * width,
		y: (659 / height) * height,
		color: "#ECBA53",
	...
	Shopping: { x: (203 / width) * width, y: (310 / height) * height, color: "#BB3E03", cnt: 0, fullname: "Shopping" },
	"Pro. Care Services": {
		x: (249 / width) * width,
		y: (231 / height) * height,
		color: "#AE2012",
	...
	Leisure: { x: (319 / width) * width, y: (173 / height) * height, color: "#9B2226", cnt: 0, fullname: "Leisure" },
	Sports: { x: (404 / width) * width, y: (141 / height) * height, color: "#A4363A", cnt: 0, fullname: "Sports" },
	Traveling: { x: width / 2, y: height / 2, color: "#C78284", cnt: 0, fullname: "Traveling" },
};
...
function App() {
	...
	useEffect(() => {
		...
		d3.select("#chart1").style("width", width + margin.left + margin.right + "px");
		// const svg2 = d3
		// 	.select("#chart2")
		// 	.append("svg")
		// 	.attr("width", width + margin.left + margin.right)
	...
	return (
		<div className='App'>
			<Typography sx={{ fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
				<Typography component='span' sx={{ color: "#C78284", fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
					VISUALIZING
				</Typography>{" "}
				<Typography component='span' sx={{ color: "#E2B0A6", fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
					OUR
				</Typography>{" "}
				<Typography component='span' sx={{ color: "#E8C9C3", fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
					LIVES
				</Typography>{" "}
				<Typography component='span' sx={{ color: "#EEE2DF", fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
					IN
				</Typography>{" "}
				<Typography component='span' sx={{ color: "#EAE1DC", fontFamily: "Kulim Park", fontSize: "3.5rem" }}>
					MOTION
				</Typography>
			</Typography>
			<Typography id='timecount' sx={{ fontSize: "2rem", textAlign: "center", ml: -2, mb: 2 }}>
