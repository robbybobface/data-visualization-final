  ...
  useEffect(() => {
    ...
    stages2021.then((data) => {
      ...
      svg1
        ...
        .attr(
          "y",
          (d) => tempGroups[d].y + groupLabelOffsets(tempGroups[d]).y + 35
        )
      ...
      function forceCollide() {
        ...
        force.initialize = (_) =>
          (maxRadius =
            max((nodes = _), (d) => d.r) + Math.max(padding1, padding2));
        return force;
      }
  ...
  return (
    <div className="App">
      ...
      >
        <Typography
          id="timecount"
          sx={{ fontSize: "2.5rem", textAlign: "center", mb: 2 }}
        >
          Time of day:{" "}
          <span className="cnt">
